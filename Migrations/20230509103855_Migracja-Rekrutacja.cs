...
{
    /// <inheritdoc />
    public partial class MigracjaRekrutacja : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    dokument_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    kandydat_id = table.Column<int>(type: "int", nullable: false),
                    pracownicy_id = table.Column<int>(type: "int", nullable: false),
                    ...
                    ścieżka_dokumentu = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    data_przesłania = table.Column<DateTime>(type: "date", nullable: false),
                    data_aktualizacji_statusu = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dokumenty_Kandydaci_kandydat_id",
                        column: x => x.kandydat_id,
                        principalTable: "Kandydaci",
                        principalColumn: "kandydat_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dokumenty_Kandydaci_pracownicy_id",
                        column: x => x.pracownicy_id,
                        principalTable: "Kandydaci",
                        principalColumn: "kandydat_id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dokumenty_kandydat_id",
                table: "Dokumenty",
                column: "kandydat_id");

            migrationBuilder.CreateIndex(
                name: "IX_Dokumenty_pracownicy_id",
                table: "Dokumenty",
